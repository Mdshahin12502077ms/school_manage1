                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex" >
                                <a href="{{url('School/subscription/Package/add')}}" style="color:rgb(126, 131, 134);margin-right:2%"><i class="fas fa-edit">Add Package</i></a>
                               <a href="{{url('School/subscription/Package/all')}}" style="color:rgb(126, 131, 134);"><i class="fas fa-tasks">All Package</i></a>
